...
import { AuthCredentials, ForgotPassword, InviteToken, RegisterCredentials, ResetPasswordType, ResetToken } from "../../domain/entities/auth.entity";
...
export class AuthApiService implements AuthRepository {
  ...
  verifyResetToken(payload: ResetToken): Observable<any> {
    return this.http.post<void>(`${this.apiUrl}/auth/validate-reset-token`, payload);
  }
